...
{
    public class CSCallLuaItfDBridge : LuaBase, CSCallLua.ItfD
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new CSCallLuaItfDBridge(reference, luaenv);
		}
		
		public CSCallLuaItfDBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
