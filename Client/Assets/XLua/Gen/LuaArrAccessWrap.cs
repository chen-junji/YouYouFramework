...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaArrAccessWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaArrAccess);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaArrAccess gen_ret = new LuaArrAccess();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaArrAccess constructor!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
		    try {
                ...
                LuaArrAccess gen_to_be_invoked = (LuaArrAccess)translator.FastGetCSObj(L, 1);
        ...
        static int _m_SetLong(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetLong( _index, _Value );
