...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(YouYou.HttpCallBackArgs p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp12(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp15(UnityEngine.Transform p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp24(StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp25(StructTest p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new YouYou.HttpSendDataCallBack(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(InvokeLua.CalcNew))
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp12);
			}
			...
			{
			    return new YouYou.LuaForm.OnInitHandler(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(YouYou.LuaForm.OnOpenHandler))
			{
			    return new YouYou.LuaForm.OnOpenHandler(__Gen_Delegate_Imp16);
			}
