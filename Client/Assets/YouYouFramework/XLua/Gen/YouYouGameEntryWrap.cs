...
namespace XLua.CSObjectWrap
{
    ...
    public class YouYouGameEntryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 3, 23, 4);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "Audio", _s_set_Audio);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "WebSocket", _s_set_WebSocket);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_Audio(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    YouYou.GameEntry.Audio = (YouYou.AudioManager)translator.GetObject(L, 1, typeof(YouYou.AudioManager));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_WebSocket(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    YouYou.GameEntry.WebSocket = (YouYou.WebSocketManager)translator.GetObject(L, 1, typeof(YouYou.WebSocketManager));
