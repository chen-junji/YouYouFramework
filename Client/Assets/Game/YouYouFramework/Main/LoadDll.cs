...
public class LoadDll : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log(System.Data.AcceptRejectRule.None);
    ...
    void StartGame()
    {
        ...
        //Instantiate(prefabAb.LoadAsset<GameObject>("HotUpdatePrefab.prefab"));

        AssetBundle prefabAb = AssetBundle.LoadFromMemory(BetterStreamingAssets.ReadAllBytes("gameentry"));
        Instantiate(prefabAb.LoadAsset<GameObject>("gameentry.prefab"));
    }
